...
if(isset($_POST['b1']))
{
mysqli_query($dbcon,"insert into reg_bank(name,email,mobile,gender,password,re_password)values('$_POST[t1]','$_POST[t2]','$_POST[t3]','$_POST[r1]','$_POST[t4]','$_POST[t5]')")or die(mysql_error());
...
if(isset($_POST['b2']))
{
mysqli_query($dbcon,"select * from reg_bank where email='$_POST[l1]' and password='$_POST[l2]'");
if(mysqli_affected_rows()>0)
{
