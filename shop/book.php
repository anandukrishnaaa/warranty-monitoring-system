...
<body>
    <section class="banner-bottom py-5">
        <div class="container py-md-5">
            <h3 class="mb-lg-5 ms-5 mb-4">Stock Request Status</h3>
            <div class="row contact_information">
                <div class="col-md-12 contact_left p-4">
<?php
$sel_p = mysqli_query($dbcon, "select * from book where sid='$usr' order by id desc");
if (mysqli_num_rows($sel_p) > 0) {
    ?>
                        ...
                        while ($r_p = mysqli_fetch_row($sel_p)) {
                            ...
                            $r1 = mysqli_fetch_row($sel1);
                            $sel2 = mysqli_query($dbcon, "select * from comp where em='$r_p[2]'");
                            $r2 = mysqli_fetch_row($sel2);
                            $i++;
                            ?>
                                <tr>
                                ...
                                if ($r_p[7] == '0') {
                                    ?>
                                            <p style="color:orange;font-size:1em;">Waiting for response</p>
                                    <?php } ?>
                                <?php
                                if ($r_p[7] == '1') {
                                    ?>

                                            <p style="color:green;font-size:1em;">Approved</p>
            <?php } ?>
        <?php
        if ($r_p[7] == '2') { ?>
                                            <p style="color: red;font-size:1em;">Order denied</p>
                                            <?php } ?>               
                                    </td>
                                </tr>
                                        <?php } ?>
