...
$sh=  mysqli_query($dbcon,"select * from shop where em='$usr'");
                          $sh1=  mysqli_fetch_row($sh);
                          
                          $dn=  mysqli_query($dbcon,"select * from sale where id='$mid'");
            ...
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div> <?php echo $sh1[7] ?></div>
                        <div> <?php echo $sh1[4] ?></div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                   ...
                   <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from sale where id='$mid'");
