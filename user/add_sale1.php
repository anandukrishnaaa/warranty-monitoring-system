        ...
        if ($r[9] < $t4) {
            ...
            if ($upd1 > 0) {
                ...
                if ($upd2 > 0) {
                    ...
                    if ($ins > 0) {
                        $del = mysqli_query($dbcon, "delete from cart where id='$r_p[0]'");
                ...
                <div class="">
                    <div class="contact_right p-5" style="background-color:#f2f2f2;">
                        <form method="post"enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-around align-items-center">
                                <div class="col-5">
                                    ...
                                    <div class="field-group">
                                        <input name="t1" class="form-control mt-4" id="text1" type="text" value="" placeholder="Full Name" required="">
                                    </div>

                                    <div class="field-group">
                                        <input name="t2" class="form-control mt-4" id="text3" type="text" value="" placeholder="Phone Number" required=""onkeyup="chkc(this.value)" /><span id="o3"></span>
                                    </div>

                                    <div class="field-group">
                                        <textarea name="ta" class="form-control mt-4" placeholder="Address" required=""></textarea>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <h4>Payment</h4>
                            ...
                            <div class="mt-4">
                                <button type="submit"name="b1" class="btn btn-success form-control">Purchase</button>
                            </div>
