...
<!--    <link rel="stylesheet" href="../assets/css/font-awesome.css" >-->
 ...
 <header class="p-4 border-bottom">
    <ul class="navbar-nav d-flex flex-row align-items-center px-5">
        ...
        <li class="ms-auto nav-item me-1"><a href="msg.php" class="nav-link p-3 text-dark" style="<?php echo $page_name == 'msg' ? 'text-decoration:underline;text-underline-offset:3px;' : '' ?>">repair status</a></li>
